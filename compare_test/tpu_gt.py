...
class TPUFloatOperationTester:
    ...
    def test_gt_operations(self) -> List[Tuple[str, str, str]]:
        """测试大于运算"""
    ...
    def print_results(self, results: List[Tuple[str, str, str]], operation: str = "gt"):
        """打印结果"""
...
def main():
    """在TPU上运行所有测试"""
    print("Starting TPU Float GT Operation Tests")
    ...
    fp32_results = fp32_tester.test_gt_operations()
    fp32_tester.print_results(fp32_results, "gt")
    ...
    bf16_results = bf16_tester.test_gt_operations()
    bf16_tester.print_results(bf16_results, "gt")
    ...
    fp32_dict = {f"{v1} gt {v2}": res for v1, v2, res in fp32_results}
    bf16_dict = {f"{v1} gt {v2}": res for v1, v2, res in bf16_results}
