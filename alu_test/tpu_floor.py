...
class TPUFloatOperationTester:
    ...
    def print_test_values_description(self):
        ...
        if self.dtype == jnp.float32:
            ...
            print("- normal: 1.5")
            print("- -normal: -1.5")
            print("- positive_fraction: 2.3")
            print("- negative_fraction: -2.3")
            print("- positive_integer: 3.0")
            print("- negative_integer: -3.0")
    ...
    def test_floor_operations(self) -> List[Tuple[str, str]]:
        """测试floor运算 - floor是单操作数运算"""
    ...
    def print_results(self, results: List[Tuple[str, str]], operation: str = "floor"):
        """打印结果"""
...
def main():
    """在TPU上运行所有测试"""
    print("Starting TPU Float FLOOR Operation Tests")
    ...
    fp32_results = fp32_tester.test_floor_operations()
    fp32_tester.print_results(fp32_results, "floor")
    ...
    bf16_results = bf16_tester.test_floor_operations()
    bf16_tester.print_results(bf16_results, "floor")
    ...
    fp32_dict = {f"floor({v})": res for v, res in fp32_results}
    bf16_dict = {f"floor({v})": res for v, res in bf16_results}
