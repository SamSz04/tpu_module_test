...
class GPUFloatOperationTester:
    ...
    def test_max_operations(self) -> List[Tuple[str, str, str]]:
        """测试最大值运算"""
    ...
    def print_results(self, results: List[Tuple[str, str, str]], operation: str = "max"):
        """打印结果"""
...
def main():
    ...
    fp32_results = fp32_tester.test_max_operations()
    fp32_tester.print_results(fp32_results, "max")
    ...
    bf16_results = bf16_tester.test_max_operations()
    bf16_tester.print_results(bf16_results, "max")
    ...
    fp32_dict = {f"{v1} max {v2}": res for v1, v2, res in fp32_results}
    bf16_dict = {f"{v1} max {v2}": res for v1, v2, res in bf16_results}
