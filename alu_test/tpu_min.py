...
class GPUFloatOperationTester:
    ...
    def test_min_operations(self) -> List[Tuple[str, str, str]]:
        """测试最小值运算"""
    ...
    def print_results(self, results: List[Tuple[str, str, str]], operation: str = "min"):
        """打印结果"""
...
def main():
    """在GPU上运行所有测试"""
    print("Starting GPU Float Operation Tests")
    ...
    fp32_results = fp32_tester.test_min_operations()
    fp32_tester.print_results(fp32_results, "min")
    ...
    bf16_results = bf16_tester.test_min_operations()
    bf16_tester.print_results(bf16_results, "min")
    ...
    fp32_dict = {f"{v1} min {v2}": res for v1, v2, res in fp32_results}
    bf16_dict = {f"{v1} min {v2}": res for v1, v2, res in bf16_results}
